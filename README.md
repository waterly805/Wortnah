...
The current editable application is version 0.5.1. See `docs/IMPLEMENTATION-LOG-2026-09-07.md` and `docs/RELEASE-NOTES-0.5.1.md` for verification and rollout status.
